...
```sh
  docker run --rm ghcr.io/<YOUR_ORG>/sonarqube-mcp:latest --print-default-config > ~/.sonarqube-mcp/config.yaml
```
...
```sh
  docker run -d --name sonarqube-mcp \
    ...
    -v ~/.sonarqube-mcp:/home/mcp/.sonarqube-mcp \
...
```sh
git clone https://github.com/<YOUR_ORG>/sonarqube-mcp.git
cd sonarqube-mcp
make build
make test
```
...
- **GitHub Issues**: [Create an issue](https://github.com/<YOUR_ORG>/sonarqube-mcp/issues)
- **Discussions**: [Start a discussion](https://github.com/<YOUR_ORG>/sonarqube-mcp/discussions)
